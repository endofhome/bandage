...
class BandageTest {
    ...
    fun `full audio track metadata can be viewed`() {
        ...
        val workingTitle1 = driver.findElement(By.cssSelector("input[data-test=\"working-title-0\"]")) ?: fail("First working title for ${exampleAudioTrackMetadata.uuid} is unavailable")
        assertThat(workingTitle1.getAttribute("value"), equalTo(exampleAudioTrackMetadata.workingTitles[0]))
        val workingTitle2 = driver.findElement(By.cssSelector("input[data-test=\"working-title-1\"]")) ?: fail("Second working title for ${exampleAudioTrackMetadata.uuid} is unavailable")
        assertThat(workingTitle2.getAttribute("value"), equalTo(exampleAudioTrackMetadata.workingTitles[1]))
