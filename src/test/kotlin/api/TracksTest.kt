...
internal class TracksTest {
    ...
    fun `tracks are available via API`(approver: Approver) {
        ...
        val metadataStorage = StubMetadataStorage(mutableListOf(
            ...
            exampleAudioTrackMetadata.copy(uuid = uuids[1], title = "in a collection", collections = listOf(Collection.ExistingCollection(uuids[2], "Awesome collection", emptySet()))),
